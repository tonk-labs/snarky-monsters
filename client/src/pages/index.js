      ...
      <Container>
        ...
        <About className="bigBox">
          ...
          <p>
            ...
            games with vibrant, trustless, intelligent agents. Furthermore, we
            are developing our own games to test this capability and inspire a
            community of game devs. Right now we are working on a cooking game
            that showcases proof of LSTM model execution and are excited to
            share it out in Q1 2023.{' '}
          </p>
        </About>
      </Container>
    </>
